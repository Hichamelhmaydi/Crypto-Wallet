...
public class Menu {
    ...
    private void afficherMenuPrincipal() {
        System.out.println("\n=== MENU PRINCIPAL ===");
        System.out.println("1. Creer un portefeuille crypto");
    ...
    private void creerPortefeuille() {
        ...
        System.out.println("Portefeuille cree avec succes!");
    ...
    private void creerTransaction() {
        if (portefeuilleActuel == null) {
            System.out.println("Veuillez d'abord creer ou selectionner un portefeuille.");
            return;
        }
        ...
        System.out.println("Transaction creee avec succes!");
    ...
    private void listerPortefeuilles() {
        ...
        if (portefeuilles.isEmpty()) {
            System.out.println("Aucun portefeuille trouve.");
            return;
        }
